...
function SemiPersonalizedProgram() {
        ...
        <>
            ...
            <section className='w-full h-64'>
              <div className='relative w-full h-full flex flex-col justify-evenly items-center text-center'>
                <h2 className='w-4/5 text-4xl font-bold text-secondary-color text-center z-10'>SEMI PERSONALIZADO</h2>
...
export {SemiPersonalizedProgram}