        ...
        <>
            ...
            <section className='w-full h-64'>
              <div className='relative w-full h-full flex flex-col justify-evenly items-center text-center'>
                <h2 className='w-4/5 text-5xl font-bold text-secondary-color text-center z-10'>PERSONALIZADO</h2>
            ...
            <section className="my-0 mx-auto w-11/12">
                ...
                <div className="w-full mb-4">
                    <h2 className="mb-4 text-3xl">Tenemos los siguientes grupos disponibles</h2>
                    <div className="w-full mb-4">
